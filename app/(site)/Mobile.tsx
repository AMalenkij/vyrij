...
export default function Mobile() {
  return (
    <div className="block lg:hidden">
      ...
      <p className="text-5xl pb-3 underline decoration-border text-end px-3">{QUOTE_TEXT_NEXT}</p>
      <p className="text-xl text-end px-3">{AUTOR}</p>
      <Link className="text-xl text-center pb-3 absolute bottom-0 inset-x-0 flex items-center justify-center gap-2" href="/timeline" type="button" prefetch>
        {EXPLORE}
        <Compass />
      </Link>
    </div>
